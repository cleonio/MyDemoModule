 ...
 * @author Cleo
 * @description
 * @className ApcheHttpClientUtil
 * @date 2020/11/5 11:40
 */

public class ApcheHttpClientUtil {

    private static Logger logger = Logger.getLogger(ApcheHttpClientUtil.class);
    ...
    //POST  有参无参  带请求头
    public static String sendPOSTRequest(String url, String json,  String accessToken) {
        // 创建Httpclient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        CloseableHttpResponse response = null;
        String resultString = "";
